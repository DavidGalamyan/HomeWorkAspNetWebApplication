...
namespace HomeWorkAspNetWebApplication.Data.Inplementation
{
    public class PersonRepository : IPersonRepository
    {
        ...
        public bool Update(Person personRequest)
        {
            var result = GetItem(personRequest.Id);
            if (result != null)
            {
                result.Age = personRequest.Age;
                result.Company = personRequest.Company;
                result.Email = personRequest.Email;
                result.FirstName = personRequest.FirstName;
                result.LastName = personRequest.LastName;
                return true;
            }
            else
            {
